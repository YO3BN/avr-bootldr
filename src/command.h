...
#define Cmnd_STK_RESET             0x32  // '2'
#define Cmnd_STK_SINGLE_CLOCK      0x33  // '3'
#define Cmnd_STK_STORE_PARAMETERS  0x34  // '4'

#define Cmnd_STK_SET_PARAMETER     0x40  // '@'
#define Cmnd_STK_GET_PARAMETER     0x41  // 'A'
#define Cmnd_STK_SET_DEVICE        0x42  // 'B'
#define Cmnd_STK_GET_DEVICE        0x43  // 'C'
#define Cmnd_STK_GET_STATUS        0x44  // 'D'
...
#define Cmnd_STK_CHECK_DEVICE      0x54  // 'T'
